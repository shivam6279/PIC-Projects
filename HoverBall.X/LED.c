...
//    float min_scale_1 = 1.0 - min_scale;
    ...
    buffer[LED_LENGTH / 2].red = (float)((float)buffer[LED_LENGTH / 2].red * 0.1);
    buffer[LED_LENGTH / 2].blue = (float)((float)buffer[LED_LENGTH / 2].blue * 0.1);
    buffer[LED_LENGTH / 2].green = (float)((float)buffer[LED_LENGTH / 2].green * 0.1);
    
    buffer[LED_LENGTH / 2 + 1].red = (float)((float)buffer[LED_LENGTH / 2 + 1].red * 0.25);
    buffer[LED_LENGTH / 2 + 1].blue = (float)((float)buffer[LED_LENGTH / 2 + 1].blue * 0.25);
    buffer[LED_LENGTH / 2 + 1].green = (float)((float)buffer[LED_LENGTH / 2 + 1].green * 0.25);
    
    buffer[LED_LENGTH / 2 - 1].red = (float)((float)buffer[LED_LENGTH / 2 - 1].red * 0.35);
    buffer[LED_LENGTH / 2 - 1].blue = (float)((float)buffer[LED_LENGTH / 2 - 1].blue * 0.35);
    buffer[LED_LENGTH / 2 - 1].green = (float)((float)buffer[LED_LENGTH / 2 - 1].green * 0.35);
