...
void send_line(unsigned char data);
...
void oled_command(unsigned char data){ 
    i2c3_write_registers(0x78, (unsigned char[2]){0, data}, 2);
} 
...
void oled_write(unsigned char data){ 
    ...
    oled_command(0x00); 
    oled_command(7); 
    i2c3_write_registers(0x78, temp, 1025);
} 

void set_xy(unsigned char row, unsigned char col){
    i2c3_write_registers(0x78, (unsigned char[2]){0, (0xB0 + row)}, 2);
    i2c3_write_registers(0x78, (unsigned char[2]){0, (col & 0x0F)}, 2);
    i2c3_write_registers(0x78, (unsigned char[2]){0, (0x10 + ((col >> 4) & 0x0F))}, 2);
}

void send_line(unsigned char data){
    i2c3_write_registers(0x78, (unsigned char[2]){0x40, data}, 2);
}
